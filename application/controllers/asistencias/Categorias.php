...
class Categorias extends CMS_Controller 
{
  public function __construct() 
  {
    ...
    $this->nommen = 'Departamentos';
    $this->nomsubmen = 'Categorias';
    $this->estsis = TRUE;
    $this->estmen = TRUE;
    $this->estsubmen = TRUE;
    $this->iderol = $this->session->userdata('iderol');
    $this->load->model('asistencias/categorias_m');
    $this->url = "asistencias/categorias/";
  }
  ...
  public function lista($valor) 
  {
    ...
    $are = $this->categorias_m->listar_areas();
    ...
    if ($ide)
      ...
      if ($valor == "T")
        $lista = $this->categorias_m->listar();
      else
        $lista = $this->categorias_m->listar_ide($valor);
