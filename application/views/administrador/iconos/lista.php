          ...
          <table id="tablas" class="table table-bordered table-hover" style="width:100%">
            <thead>
              <tr>
                ...
                <th><span class="ltitulo">NOMBRE</span></th>
                <th><span class="ltitulo">IMAGEN</span></th>
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="ldato"><?php echo $lis[$x]-> desico?></span></td>
                        
                        <td><span class="ldato"><?php echo $lis[$x]->nomico ?></span></td>
                         <td class="<?php echo $lis[$x]->desico;?>"></td>
