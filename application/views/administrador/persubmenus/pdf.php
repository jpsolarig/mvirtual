<?php $this->load->view('administrador/comun/head_pdf'); ?>
<body>
    <table align="center" width="87%">
        <thead>
            ...
            <tr>
                ...
                <th class="titulo_m" width="17%">ROLES</th>
                <th class="titulo_m" width="17%">SISTEMAS</th>
                <th class="titulo_m" width="15%">MENUS</th>
                <th class="titulo_m" width="17%">SUBMENUS</th>
                <th id="titulo_f" width="15%">ESTADOS</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="celda_m" width="17%"><?php echo $l->nomrol; ?></td>
                <td class="celda_m" width="17%"><?php echo $l->nomsis; ?></td>
                <td class="celda_m" width="15%"><?php echo $l->nommen; ?></td>
                <td class="celda_m" width="17%"><?php echo $l->nomsubmen; ?></td>
                <td id="celda_f" width="15%"><?php echo $l->estsubmen; ?></td>
            </tr>
            <?php $i++; endforeach; ?>
        </tbody>
    </table>
