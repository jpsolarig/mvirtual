      ...
      <div class="modal-body">
        <form action="" method="POST" role="form" autocomplete="off">
          ...
          <div class="form-group text-primary input-group-sm">
            ...
            <input name="dato_4" id="dato_4" type="text" maxlength="50" class="form-control" placeholder="Descripción del Menu" tabindex="2">
          </div>
          
          <div class="form-group text-primary input-group-sm">
            <label for="">Contraseña</label>
            <input name="dato_5" id="dato_5" type="password" maxlength="25" class="form-control" placeholder="Descripción del Menu" tabindex="2" disabled>
          </div>
          
          <div class="form-group text-primary input-group-sm">
            <label for="" ><i class="fa fa-pencil"></i> Estado</label>
            <select name="dato_6" id="dato_6" class="form-control" style="font-weight: bold">
