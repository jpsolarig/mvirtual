            ...
            <tbody>
              <?php $i=1; for ($x=0; $x < count($lis) ; $x++) { ?>
                <tr>
                  ...
                  <td><?php echo $lis[$x]->desrol;?></td>
                  <td><?php echo $lis[$x]->ordrol;?></td>
                                   
                  <?php  if ($peract == 1): ?>
                    <td class="tdact">
                      <a  class="ideact" href="" data-valor="<?php echo $lis[$x]->iderol;?>">
                  ...
                  <?php if ($pereli == 1): ?>
                    <td class="tdact">
                      <a  class="ideeli" href="" data-toggle="modal" data-eli="<?php echo $lis[$x]->iderol;?>">
