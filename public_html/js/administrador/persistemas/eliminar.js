...
$(function(){
    $(".persistemas").on('click', '.ideeli',function(e)
    {
      e.preventDefault();
...
$(function(){
    ...
    $(".container").on('click', '.ideeli',function(e)
    {
       e.preventDefault();
       ide = $(this).attr("data-eli");
       ide2 = $(this).attr("data-eli2");
	...
	$.ajax({
        ...
        .done(function(response){
            if (Boolean(response.result)===true) 
            {
                ...
                var tres = 3000; 
                setTimeout(function(){ $('#eliminarok').modal('hide');}, tres);
                ...
                setTimeout(function(){ 
                    ...
                    window.location.href = baseURL +"lista/"+id;
                }, uno);
