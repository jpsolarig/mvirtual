...
#
# TABLE STRUCTURE FOR: t_equipos
#

CREATE TABLE `t_equipos` (
  `ideequ` int(11) NOT NULL AUTO_INCREMENT,
  `nomequ` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`ideequ`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

INSERT INTO `t_equipos` (`ideequ`, `nomequ`) VALUES (1, 'PCS');
INSERT INTO `t_equipos` (`ideequ`, `nomequ`) VALUES (2, 'PROYECTORES');
INSERT INTO `t_equipos` (`ideequ`, `nomequ`) VALUES (3, 'PIZARRAS');
INSERT INTO `t_equipos` (`ideequ`, `nomequ`) VALUES (4, 'MONITORES');
INSERT INTO `t_equipos` (`ideequ`, `nomequ`) VALUES (5, 'TECLADOS');
